      ...
      <section id="how-it-works" className="py-16 px-4 bg-gradient-to-b from-green-50 to-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mt-12">
            <Link href="/checkout" className="bg-green-600 text-white px-10 py-5 rounded-lg text-xl font-bold hover:bg-green-700 transition-colors inline-block shadow-lg">
