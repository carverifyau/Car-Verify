    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <div className="mt-8">
            ...
            <p className="text-sm text-gray-700 mt-3">Instant results • Official PPSR certificate • All WA vehicles</p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-12">
          <div className="flex items-start space-x-3 bg-white p-6 rounded-lg shadow-sm">
            ...
            <div>
              ...
              <p className="text-sm text-gray-800">Direct access to government PPSR registry for accurate Perth & WA vehicle information</p>
            </div>
          </div>
          <div className="flex items-start space-x-3 bg-white p-6 rounded-lg shadow-sm">
            <CheckCircle className="h-8 w-8 text-green-600 flex-shrink-0" />
            <div>
              <h3 className="font-semibold text-gray-900 mb-1">Instant Perth Results</h3>
              <p className="text-sm text-gray-800">Get your complete REVS certificate for any WA vehicle in seconds</p>
            </div>
          </div>
          <div className="flex items-start space-x-3 bg-white p-6 rounded-lg shadow-sm">
            <DollarSign className="h-8 w-8 text-blue-600 flex-shrink-0" />
            <div>
              <h3 className="font-semibold text-gray-900 mb-1">Perth's Best Value</h3>
              <p className="text-sm text-gray-800">Comprehensive vehicle history check from just $34.99</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">What is a REVS Check in Perth?</h2>
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Why Perth Car Buyers Need a REVS Check</h2>
          <div className="space-y-6">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Protect Your Investment in Perth's Market</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Finance Owing is Common in WA</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Stolen Vehicles in Perth</h3>
              <p className="text-gray-800">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Write-Off History Matters in WA</h3>
              <p className="text-gray-800">
      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-gray-900 mb-8">Perth REVS Check FAQs</h2>
          
          <div className="space-y-6">
            <div className="border-b border-gray-200 pb-6">
              <h3 className="text-xl font-semibold text-gray-900 mb-3">How much does a REVS check cost in Perth?</h3>
              <p className="text-gray-800">
            ...
            <div className="border-b border-gray-200 pb-6">
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Do I need a REVS check for every car I look at in Perth?</h3>
              <p className="text-gray-800">
            ...
            <div className="border-b border-gray-200 pb-6">
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Can I do a free REVS check in Perth?</h3>
              <p className="text-gray-800">
            ...
            <div className="border-b border-gray-200 pb-6">
              <h3 className="text-xl font-semibold text-gray-900 mb-3">What's the difference between a REVS check and a PPSR check in Perth?</h3>
              <p className="text-gray-800">
            ...
            <div className="border-b border-gray-200 pb-6">
              <h3 className="text-xl font-semibold text-gray-900 mb-3">How quickly do I get my REVS check results in Perth?</h3>
              <p className="text-gray-800">
            ...
            <div className="border-b border-gray-200 pb-6">
              <h3 className="text-xl font-semibold text-gray-900 mb-3">What information do I need to do a REVS check in Perth?</h3>
              <p className="text-gray-800">
            ...
            <div className="border-b border-gray-200 pb-6">
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Does a REVS check work for motorcycles and boats in Perth?</h3>
              <p className="text-gray-800">
            ...
            <div className="border-b border-gray-200 pb-6">
              <h3 className="text-xl font-semibold text-gray-900 mb-3">What happens if my Perth REVS check shows finance owing?</h3>
              <p className="text-gray-800">
            ...
            <div className="border-b border-gray-200 pb-6">
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Is a REVS check mandatory when buying a car in Perth?</h3>
              <p className="text-gray-800">
            ...
            <div className="pb-6">
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Can I trust Car Verify for my Perth REVS check?</h3>
              <p className="text-gray-800">
      ...
      <section className="py-16 px-4 bg-blue-600 text-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-4">Protect Yourself When Buying a Car in Perth</h2>
