        ...
        <section className="mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-600">
            ...
            <div className="text-center my-8">
              ...
              <p className="text-sm text-gray-500 mt-2">Instant results • Official certificate • Essential first step</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-600">
            ...
            <div className="text-center my-8">
              ...
              <p className="text-sm text-gray-500 mt-2">Instant verification • Official government check</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-600">
            ...
            <div className="text-center my-8">
              ...
              <p className="text-sm text-gray-500 mt-2">Know exactly what the car is worth</p>
            </div>
          </div>
        </section>
            ...
            <div className="bg-red-50 rounded-lg p-6 space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Never buy a car with registered finance. You inherit the debt.</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">This always means they're hiding expensive problems.</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Could be stolen, rebirthed, or written off.</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Especially on European cars, this means big bills are coming.</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">"Must sell today" = they know about problems you haven't found yet.</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Statutory write-offs cannot be re-registered. Repairable write-offs need disclosure.</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Major accident repairs often hide frame damage.</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Indicates flood damage - electrical nightmares ahead.</p>
                </div>
              </div>
            </div>
          </div>
