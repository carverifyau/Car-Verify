      ...
      <section className="py-16 px-4 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <div className="mt-8">
            ...
            <p className="text-sm text-gray-700 mt-3">Instant results • Official PPSR certificate • All NSW vehicles</p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-12">
          <div className="flex items-start space-x-3 bg-white p-6 rounded-lg shadow-sm">
            ...
            <div>
              ...
              <p className="text-sm text-gray-800">Direct access to government PPSR registry for accurate Sydney & NSW vehicle information</p>
            </div>
          </div>
          <div className="flex items-start space-x-3 bg-white p-6 rounded-lg shadow-sm">
            ...
            <div>
              ...
              <p className="text-sm text-gray-800">Get your complete REVS certificate for any NSW vehicle in seconds</p>
            </div>
          </div>
          <div className="flex items-start space-x-3 bg-white p-6 rounded-lg shadow-sm">
