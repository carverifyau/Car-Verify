      ...
      <section className="py-16 px-4 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <div className="mt-8">
            ...
            <p className="text-sm text-gray-500 mt-3">Instant results • Official government certificate • All Australian vehicles</p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-12">
          <div className="flex items-start space-x-3 bg-white p-6 rounded-lg shadow-sm">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Government-issued certificate from the official PPSR database</p>
            </div>
          </div>
          <div className="flex items-start space-x-3 bg-white p-6 rounded-lg shadow-sm">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Get your PPSR certificate for any Australian vehicle in seconds</p>
            </div>
          </div>
          <div className="flex items-start space-x-3 bg-white p-6 rounded-lg shadow-sm">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Comprehensive PPSR check with vehicle history from just $34.99</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-sm text-gray-600">Government-issued certificate with legal standing, accepted by insurance companies, banks, and legal professionals</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-sm text-gray-600">Complete search of all registered security interests, loans, and financial encumbrances</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-sm text-gray-600">Written-Off Vehicle Register (WOVR) check for insurance write-offs due to accident, flood, fire, or hail damage</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-sm text-gray-600">Cross-reference with Australian stolen vehicle databases to verify the car isn't reported stolen</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-sm text-gray-600">Complete vehicle details including make, model, year, engine, transmission, and registration history</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-sm text-gray-600">Expert market research showing current market value range based on condition, mileage, and location</p>
            </div>
          </div>
