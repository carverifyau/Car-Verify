    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-12">
          <div className="flex items-start space-x-3 bg-white p-6 rounded-lg shadow-sm">
            ...
            <div>
              <h3 className="text-black font-semibold text-black mb-1">Official PPSR Certificate</h3>
          ...
          <div className="flex items-start space-x-3 bg-white p-6 rounded-lg shadow-sm">
            ...
            <div>
              <h3 className="text-black font-semibold text-black mb-1">Instant Results</h3>
          ...
          <div className="flex items-start space-x-3 bg-white p-6 rounded-lg shadow-sm">
            ...
            <div>
              <h3 className="text-black font-semibold text-black mb-1">Best Value</h3>
      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-black text-3xl font-bold mb-6">What is a PPSR Check?</h2>
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-black text-3xl font-bold mb-6">Why You Need a PPSR Check</h2>
          <div className="space-y-6">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-black text-xl font-semibold mb-3">Legal Protection Against Inherited Debt</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-black text-xl font-semibold mb-3">Finance Owing is Common</h3>
              <p className="text-black mb-3">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-black text-xl font-semibold mb-3">Write-Offs and Stolen Vehicles</h3>
              <p className="text-black">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="text-black text-xl font-semibold mb-3">Required for Insurance and Finance</h3>
              <p className="text-black">
      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-black text-3xl font-bold mb-8">PPSR Check FAQs</h2>

          <div className="space-y-6">
            <div className="border-b border-gray-200 pb-6">
              <h3 className="text-black text-xl font-semibold mb-3">How much does an official PPSR check cost?</h3>
              <p className="text-black">
            ...
            <div className="border-b border-gray-200 pb-6">
              <h3 className="text-black text-xl font-semibold mb-3">What's the difference between PPSR and REVS?</h3>
              <p className="text-black">
            ...
            <div className="border-b border-gray-200 pb-6">
              <h3 className="text-black text-xl font-semibold mb-3">Can I do a free PPSR check?</h3>
              <p className="text-black">
            ...
            <div className="border-b border-gray-200 pb-6">
              <h3 className="text-black text-xl font-semibold mb-3">How quickly do I get my PPSR certificate?</h3>
              <p className="text-black">
            ...
            <div className="border-b border-gray-200 pb-6">
              <h3 className="text-black text-xl font-semibold mb-3">What information do I need for a PPSR check?</h3>
              <p className="text-black">
            ...
            <div className="border-b border-gray-200 pb-6">
              <h3 className="text-black text-xl font-semibold mb-3">Does a PPSR check work for motorcycles, caravans, and boats?</h3>
              <p className="text-black">
            ...
            <div className="border-b border-gray-200 pb-6">
              <h3 className="text-black text-xl font-semibold mb-3">What happens if my PPSR check shows finance owing?</h3>
              <p className="text-black">
            ...
            <div className="border-b border-gray-200 pb-6">
              <h3 className="text-black text-xl font-semibold mb-3">Is a PPSR check mandatory when buying a car?</h3>
              <p className="text-black">
            ...
            <div className="border-b border-gray-200 pb-6">
              <h3 className="text-black text-xl font-semibold mb-3">What is a security interest on the PPSR?</h3>
              <p className="text-black">
            ...
            <div className="pb-6">
              <h3 className="text-black text-xl font-semibold mb-3">How do I read a PPSR certificate?</h3>
              <p className="text-black">
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-black text-3xl font-bold mb-6 text-center">What's Included in Your PPSR Check</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <div className="flex items-center mb-4">
                <FileCheck className="h-6 w-6 text-blue-600 mr-3" />
                <h3 className="text-black font-semibold text-black">Official PPSR Certificate</h3>
              </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-black font-semibold text-black">Finance Owing Check</h3>
              </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-black font-semibold text-black">Write-Off History</h3>
              </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-black font-semibold text-black">Stolen Vehicle Check</h3>
              </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-black font-semibold text-black">Vehicle Specifications</h3>
              </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-black font-semibold text-black">Market Valuation</h3>
              </div>
      ...
      <section className="py-16 px-4 bg-blue-600 text-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-black text-3xl font-bold mb-4">Protect Yourself with an Official PPSR Certificate</h2>
